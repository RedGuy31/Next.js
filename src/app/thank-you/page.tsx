    ...
    <main className=" relative lg:min-h-full">
      <div className=" hidden lg:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12 ">
        <Image
          sizes="medium"
          fill
          src="/chechout-thank-you.jpg"
          alt="thank you from your order"
      ...
      <div>
        <div className=" mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className=" lg:col-start-2">
            ...
            <h1 className=" mt-2 font-bold text-4xl tracking-tighter text-gray-900 sm:text-5xl">
              Thanks for ordering
            </h1>
            {order._isPaid ? (
            ...
            <ul className="mt-6 divide-y divide-green-200 border-t border-green-200 text-sm font-medium text-muted-foreground">
              {(order.products as Product[]).map((product) => {
                const label = PORDUCT_CATEGORIES.find(
                    ...
                    <div className="relative h-24 w-24">
                      {typeof image !== "string" && image.url ? (
                        <Image
                          ...
                          className="flex-none rounded-md bg-green-100 object-cover object-center"
                        />
                      ) : null}
                    </div>
            ...
            <div className="space-y-6 border-t border-green-200 pt-6 text-sm font-medium text-muted-foreground">
              ...
              <div className="flex items-center justify-between border-t border-green-200 pt-6 text-gray-900">
